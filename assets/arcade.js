(() => {
  ...
  const games = {
    ...
    pinball: { name: 'Neon Pinball', path: '/arcade/pinball/', type: '02 / NEON ARCADE', tagline: '再救回这一球。', description: '青绿、玫红和暖黄灯光，照亮一张微缩弹球台。银球滚过轨道，双挡板把它送回场内。', rules: '每局三球。碰撞器得 100 分；点亮三枚目标，累积最高 5 倍倍率。', controls: [['A / ←', '左挡板'], ['D / →', '右挡板'], ['Space', '发球'], ['触屏按钮', '挡板与发球']], note: '三维弹球 · 单人' },
